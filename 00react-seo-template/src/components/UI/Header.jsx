                    ...
                    <div className="search-popup-container">
                         ...
                         <ul className="cat-list">
                              <li className="cat-list-item">
                                   <NavLink to="#" title="Jackets">
                                        Jackets
                                   </NavLink>
                              </li>
                              <li className="cat-list-item">
                                   <NavLink to="#" title="T-shirts">
                                        T-shirts
                                   </NavLink>
                              </li>
                              <li className="cat-list-item">
                                   <NavLink to="#" title="Handbags">
                                        Handbags
                                   </NavLink>
                              </li>
                              <li className="cat-list-item">
                                   <NavLink to="#" title="Accessories">
                                        Accessories
                                   </NavLink>
                              </li>
                              <li className="cat-list-item">
                                   <NavLink to="#" title="Cosmetics">
                                        Cosmetics
                                   </NavLink>
                              </li>
                              <li className="cat-list-item">
                                   <NavLink to="#" title="Dresses">
                                        Dresses
                                   </NavLink>
                              </li>
                              <li className="cat-list-item">
                                   <NavLink to="#" title="Jumpsuits">
                                        Jumpsuits
                                   </NavLink>
                              </li>
                         </ul>
                    ...
                    <div className="container-fluid">
                         <div className="row justify-content-between align-items-center w-100">
                              <div className="col-auto">
                                   <NavLink className="navbar-brand text-white" to="index.html">
                                        <svg
                                             width={112}
                                             height={45}
                                             viewBox="0 0 112 45"
                              ...
                              <div className="col-3 col-lg-auto">
                                   <ul className="list-unstyled d-flex m-0">
                                        <li className="d-none d-lg-block">
                                             <NavLink to="index.html" className="text-uppercase mx-3">
                                        ...
                                        <li className="search-box">
                                             <NavLink to="#search" className="search-button">
                                                  <svg width={24} height={24} viewBox="0 0 24 24">
                                                       <use xlinkHref="#search"></use>
                                                  </svg>
                                             </NavLink>
